                        ...
                        <div className="card card-profile shadow">
                            <div className="row justify-content-center">
                                <div className="col-lg-3 order-lg-2">
                                    <div className="card-profile-image">
                                        <a href="link">
                                            <img src="https://demos.creative-tim.com/argon-dashboard/assets-old/img/theme/team-4.jpg" className="rounded-circle" alt=""/>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div className="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                                <div className="d-flex justify-content-between">
                                    <a href="link" className="btn btn-sm btn-info mr-4">Connect</a>
                                    <a href="link" className="btn btn-sm btn-default float-right">Message</a>
                                </div>
                            </div>
                            ...
                            <div className="card-header bg-white border-0">
                                <div className="row align-items-center">
                                    ...
                                    <div className="col-4 text-right">
                                        <a href="link!" className="btn btn-sm btn-primary">Settings</a>
                                    </div>
                                </div>
                            </div>
